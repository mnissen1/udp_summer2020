...
# Files
## PSM results
total_stats_all_file <- 
  paste0(homedir, savedir, "writeup_results/total_stats_all.csv")

## ACS
all_years_tract_ca_file <- paste0(homedir, savedir, "all_years_tract_CA.csv")

## NOAH 
noah_00_file <- paste0(homedir, workdir, "NOAH_SGC_2000.csv")
...
noah_00_xwalk %>% write_csv(paste0(homedir, savedir, "NOAH_SGC_2000_xwalk.csv"))
```
