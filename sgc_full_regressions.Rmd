...
total_reg_df <-
  ...
  left_join(all_years_tract_ca, by = "GEOID") %>% 
...
ivs_00 <-
  paste(
    "investment + la_flag + sf_flag + greening + transit + urban_infill + active_transportation +",
    vars_00
  )
...
ivs_00 <-
  paste(
    "investment + greening + transit + urban_infill + active_transportation +",
    vars_00
  )
