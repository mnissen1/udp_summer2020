...
# Generate code to add investment markers
```{r}
...
* Reduce map loading speeding (full area)
** abandoning, use loading spinner (doesn't seem to work with proxy)

* reduce legend size

* change width ratio (give map more space)
